...
MAP_PRIVATE_ANON equ 0x22  ; MAP_PRIVATE | MAP_ANONYMOUS
...
main:
    ...
    ; buf = mmap(NULL, INITIAL_CAP, PROT_READ|PROT_WRITE, MAP_PRIVATE|MAP_ANONYMOUS, -1, 0)
    mov  rax, SYS_MMAP
    mov  rdi, 0
    mov  rsi, INITIAL_CAP
    mov  rdx, PROT_RW
...
.grow:
    ...
    ; new_buf = mmap(NULL, new_cap, PROT_READ|PROT_WRITE, MAP_PRIVATE|MAP_ANONYMOUS, -1, 0)
    mov  rax, SYS_MMAP
    mov  rdi, 0
    mov  rsi, r15
    mov  rdx, PROT_RW
